...
class TnTrackedDcMotorActuator(
    ...
    def _clip_effort(self, effort: torch.Tensor) -> torch.Tensor:
        ...
        return torch.clamp(effort, min=lower_effort, max=upper_effort)
...
class TorqueSpeedCurveActuator(
    IdealPdActuator[TorqueSpeedCurveActuatorCfg],
    _TnViolationAccumulatorMixin,
):
    ...
    def effort_bounds(self) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        return -torque_limit, torque_limit
