...
def env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
    ...
    command_cfg.height_balance_schedule_enabled = True
    command_cfg.height_balance_value = _DEFAULT_STANDING_HEIGHT
    command_cfg.height_balance_stable_tilt_deg = 15.0
    command_cfg.height_balance_stable_ang_vel_xy = 0.8
    command_cfg.height_balance_stable_steps = 25
    command_cfg.height_balance_rise_rate = 0.1
    command_cfg.height_balance_completion_tolerance = 0.002
    command_cfg.height_balance_log_interval_steps = 64
    command_cfg.standing_ratio = 0.02
    command_cfg.exclusive_linear_yaw_commands = True
    command_cfg.linear_command_ratio = 0.5
