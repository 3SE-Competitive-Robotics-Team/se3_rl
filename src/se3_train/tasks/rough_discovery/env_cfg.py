...
_ROUGH_DISCOVERY_STAIR_HEIGHT_MAX = 0.05
_ROUGH_DISCOVERY_HEIGHT_MIN_CLAMPS = ((0.04, 0.26),)
...
def _terrain_level_stages() -> list[dict[str, int]]:
    return [
        ...
        {"iteration": 1600, "max_level": 3},
        {"iteration": 2600, "max_level": 4},
        {"iteration": 3800, "max_level": 5},
        {"iteration": 5000, "max_level": _int_env("SE3_ROUGH_DISCOVERY_MAX_LEVEL", 5)},
    ]
...
def env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
    ...
    reset_params["stair_approach_curriculum_stages"] = None
    reset_params["stair_contact_curriculum_stages"] = None
