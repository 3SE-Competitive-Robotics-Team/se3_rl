...
from .env_cfg import FLAT_WHEEL_ACTION_SCALE, env_cfg, history_env_cfg
...
def register() -> None:
    ...
    register_mjlab_task(
        ...
        env_cfg=history_env_cfg(wheel_action_scale=FLAT_WHEEL_ACTION_SCALE),
        play_env_cfg=history_env_cfg(play=True, wheel_action_scale=FLAT_WHEEL_ACTION_SCALE),
