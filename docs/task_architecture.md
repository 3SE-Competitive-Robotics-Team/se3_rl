...
| `wheel_dog/blind_climb/` | `SE3-WheelDog-BlindClimb-GRU` | 20kg、16DOF 四足轮腿 WheelDog 盲爬坑坡任务，使用长起跑平台、坑、反飞坡竖直面和长落地平台构成完整路线；actor 不看地形高度，critic 额外看高度网格，课程按坑坡难度和前向进度推进；训练地形保留 25% 纯平地 episode，用于防止盲爬专项续训遗忘 flat locomotion |
