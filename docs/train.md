...
uv run --env-file .env se3-train SE3-WheelLegged-Recovery-Discovery-GRU --gpu-ids all --env.scene.num-envs 4096

# gpufree L40S 单卡：8192 envs
uv run --env-file .env se3-train SE3-WheelLegged-Recovery-Discovery-GRU --gpu-ids 0 --env.scene.num-envs 8192
```
