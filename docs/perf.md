...
本文档记录当前本地电脑的训练吞吐基线,用于后续对比 Jetson Orin NX、RTX 4060/4060 Ti、RTX 4090/5090 等设备。
...
`Total steps` 也与第 23 轮日志一致:

```text
512 * 32 * 24 = 393216
```

这里的 iteration 从 0 开始计数,所以 `Learning iteration 23` 对应已经完成 24 轮采样。
